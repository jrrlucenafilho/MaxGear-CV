...
int Car::getnCarDirection() { return nCarDirection; }

float Car::getfCarPos() { return fCarPos; }

float Car::getnCarPos() { return nCarPos; }

float Car::getfSpeed() { return fSpeed; }

float Car::getfCarCurvature() { return fCarCurvature; }

void Car::setnCarDirection(int newnDirection) { nCarDirection = newnDirection; }

void Car::setfCarPos(float newfCarPos) { fCarPos = newfCarPos; }

void Car::setnCarPos(int newnCarPos) { nCarPos = newnCarPos; }

void Car::setfSpeed(float newfSpeed) { fSpeed = newfSpeed; }

void Car::setfCarCurvature(float newCurvature) { fCarCurvature = newCurvature; }

void Car::addTofSpeed(float plusfSpeed) { fSpeed += plusfSpeed; }

void Car::deductFromfSpeed(float minusfSpeed) { fSpeed -= minusfSpeed; }
...
// TODO: Optimize this by using sprites for the car, loading it just once and
// saving as a 2d array
