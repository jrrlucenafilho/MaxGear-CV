...
Tracks::Tracks() {  // Assuming trackOption has been set before, else sets
                    // standart track
  fTrackDistance = 0.0f;
...
Pixel Tracks::getGroundColor1() { return groundColor1; }

Pixel Tracks::getGroundColor2() { return groundColor2; }

Pixel Tracks::getClipColor1() { return clipColor1; }

Pixel Tracks::getClipColor2() { return clipColor2; }

Pixel Tracks::getRoadColor() { return roadColor; }

Pixel Tracks::getHillsColor() { return hillsColor; }

Pixel Tracks::getSkyColor() { return skyColor; }

float Tracks::getTrackDistance() { return fTrackDistance; }

float Tracks::getfTrackCurvature() { return fTrackCurvature; }

std::vector<std::pair<float, float>> Tracks::getTrackVec() { return trackVec; }

int Tracks::getnHillHeight() { return nHillHeight; }

int Tracks::getTrackOption() { return trackOption; }

void Tracks::setTrack(int option) { trackOption = option; }
...
void Tracks::calcTrackDistance() {  // Calculate total track distance, so as to
                                    // set lap times
